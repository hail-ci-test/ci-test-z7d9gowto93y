...
def init_parser(parser):
    ...
    parser.add_argument("--excluded_steps", "-e", nargs='+', action='append',
                        help="Comma or space-separated list of steps to forcibly exclude. Use with caution!", required=True)
